...
Instead of training 10 different classifiers for 10 different language classes one binary classifier was trained determining
whether a given example belongs to a language class we are viewing the example from.
