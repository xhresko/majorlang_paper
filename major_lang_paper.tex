...
\section{Languages}
 ...
 \end{table}
  ...
  to train proper classifier. 
  We approached this issue the following way. Based on the assumption that all language classes behave uniformly with respect
  to features
  We handled this aspect of the task by joining all positive samples 
