...
\section{Languages}
 ...
 We looked at each example from the perspective of all nine languages. The 
  ...
  it was analyzed from.  Thus we generated eight false training instances and 
 ...
 \end{figure}
  ...
  During the evaluation phase then we simply create nine samples for any given URL
  and use the classifier for rank them, using the probability of possitive label as rank value.
