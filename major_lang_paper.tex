...
\subsubsection{Language-specific features}
 ...
 \section{Evaluation ....prihodit srovnani s minulym algoritmem, nebo tabulku s fíčurama?,DODAT KOMENT K TRÍČKKU JAK JSME UDĚLAL BINARY CLASSIFIER}
 ...
 To make current alorhitm perform even better, we see an opportunity in web page type
 classifier. If this worked with higher precision, it would be possible to set aside
 difficult web pages such as e-shops and machine learning algorhitm would be able to
 pick better features.
 The above desribed approach towards major language detection has been implemented
 and is currently used in Seznam.cz to dete
